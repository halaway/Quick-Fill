...
function autoFillForm(savedEmail, savedPassword) {
    ...
    if (firstPassword) {
        ...
        firstPassword.dispatchEvent(new Event('input', {
            bubbles: true
        }));
        firstPassword.dispatchEvent(new Event('change', {
            bubbles: true
        }));
        firstPassword.dispatchEvent(new Event('blur', {
            bubbles: true
        }));
    }
    ...
    if (secondPassword) {
        ...
        setTimeout(() => {
            ...
            secondPassword.dispatchEvent(new Event('input', {
                bubbles: true
            }));
            secondPassword.dispatchEvent(new Event('change', {
                bubbles: true
            }));
            secondPassword.dispatchEvent(new Event('blur', {
                bubbles: true
            }));
